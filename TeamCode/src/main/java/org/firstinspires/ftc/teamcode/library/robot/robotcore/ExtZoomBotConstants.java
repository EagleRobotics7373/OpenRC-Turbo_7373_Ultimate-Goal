...
public class ExtZoomBotConstants {
    ...
    public static double RING_LOAD_SERVO_PUSH = 0.5;
    public static double RING_LOAD_SERVO_BACK = 0.18;
    ...
    public static PIDFCoefficients VELOCITY_PID = new PIDFCoefficients(80, 0, 0, 13.5);
