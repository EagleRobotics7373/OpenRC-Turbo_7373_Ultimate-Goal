...
open class Gen2Robot(protected val hardwareMap: HardwareMap) {
...
//     @JvmField val backRightMotor          : DcMotor               = hwInit("backRightMotor")
     ...
     @JvmField val intakeLiftLeft  : DcMotor               = hwInit("intakeLiftLeft")
     @JvmField val intakeLiftRight : DcMotor               = hwInit("intakeLiftRight")
     @JvmField val intakePivot     : DcMotor               = hwInit("intakePivot")
