...
class IMUController @JvmOverloads constructor(hardwareMap: HardwareMap, private val axesOrder: AxesOrder = AxesOrder.ZYX, id: String = "imuA") {
    @JvmField val imuA          : BNO055IMU = hardwareMap.get(BNO055IMU::class.java, id)
