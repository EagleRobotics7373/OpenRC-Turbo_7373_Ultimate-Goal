...
object RobotConstantsAccessor {
     ...
     */
    var loadedDriveClass : Class<out Any> = DriveConstantsNew::class.java
        set(value) { field = value.takeIf { it.name.contains("DriveConstants") } ?: DriveConstantsNew::class.java}
