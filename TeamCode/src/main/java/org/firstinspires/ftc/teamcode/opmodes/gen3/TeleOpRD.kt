...
//
    ...
    private fun controlTelemetry() {
        ...
        telemetry.addLine()
        telemetry.addData("ring present 1", robot.magazineRingSensor1.ringPresent)
        telemetry.addData("ring present 2", robot.magazineRingSensor2.ringPresent)
        telemetry.addData("ring present 3", robot.magazineRingSensor3.ringPresent)
        telemetry.update()
        lastR = now
