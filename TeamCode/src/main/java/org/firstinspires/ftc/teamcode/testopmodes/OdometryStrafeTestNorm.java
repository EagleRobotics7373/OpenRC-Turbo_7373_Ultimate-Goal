...
public class OdometryStrafeTestNorm extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.odometryXAxis.resetSWCounter();
        {
                        ...
                        double c1 = robot.odometryXAxis.getDistanceNormalized(DistanceUnit.INCH);
                        double t1 = robot.odometryXAxis.getDistanceNormalized(DistanceUnit.INCH) + OdometryStrafeTestNormConfig.distance;
                        double errorSum = 0;
                        ...
                        do {
                            c1 = robot.odometryXAxis.getDistanceNormalized(DistanceUnit.INCH);
