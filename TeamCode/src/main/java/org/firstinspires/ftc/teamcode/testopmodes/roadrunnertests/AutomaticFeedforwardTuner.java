...
import org.firstinspires.ftc.teamcode.library.functions.roadrunnersupport.RegressionUtil;
...
public class AutomaticFeedforwardTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        HolonomicRR drive = RobotProvider.providePresetRobot(hardwareMap).getHolonomicRR();
        ...
        double maxVel = RobotConstantsAccessor.INSTANCE.rpmToVelocity(RobotConstantsAccessor.INSTANCE.getMaxRPM());
